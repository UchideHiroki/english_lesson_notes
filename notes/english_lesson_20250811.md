...
- Ankiクロズ作成（例）
  ...
  - Let’s run it {{c1::by}} Legal and see what they have to say.
...
## 会議で使う動詞の使い分け（cover / discuss / mention / refer to）
...
- opt in (to) + 名詞 / opt out of + 名詞: 参加する／やめる（登録系の定型）。
